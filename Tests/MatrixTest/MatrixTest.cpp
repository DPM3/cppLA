...
int main() {
	...
	cout << det(mat1) << endl; //-2
	cout << hasInv(mat1) << endl; //true
	cout << adj(mat1) << endl; //[[4, -2],[-3, 1]]
	cout << inv(mat1) << endl; //[[-2, 1],[1.5, -0.5]]
	cout << mat1.row(0) << endl; //[1, 2]
	cout << mat1.col(0) << endl; //[1, 3]
	mat1.rowRef(0) = 2 * mat1.row(0);
	cout << mat1 << endl; //[[2, 4],[3, 4]]
	mat1.colRef(1) = mat1.col(0) + mat1.col(1);
	...
	Matrix<2,3> mat3 = minor(mat2, 2, 3);
